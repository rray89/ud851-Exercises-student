...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    // COMPLETED TODO (2) Modify the setupSharedPreferences method and onSharedPreferencesChanged method to
    ...
    @Override
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) throws IllegalArgumentException{
...
//                break;
//            default:
//                throw new IllegalAccessException("Invalid entry");
//        }
    }
