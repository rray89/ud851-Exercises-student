...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenWebpageButton(View v) {
        ...
        //Toast.makeText(this, "NOTTODO: Open a web page when this button is clicked", Toast.LENGTH_SHORT).show();
    ...
    private void openWebPage(String url) {
        ...
        // COMPELTED TODO (3) Create an Intent with Intent.ACTION_VIEW and the webpage Uri as parameters
